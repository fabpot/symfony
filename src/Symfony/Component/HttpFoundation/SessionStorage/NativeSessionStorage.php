...
class NativeSessionStorage implements SessionStorageInterface
{
     ...
     *  * cache_limiter: The session cache limiter (none by default)
     ...
     *
     * The default values for 'lifetime', 'path', 'domain', 'secure' and 'httponly' options are those returned by the session_get_cookie_params() function
     *
