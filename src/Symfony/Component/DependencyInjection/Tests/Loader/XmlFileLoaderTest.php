...
class XmlFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoadServices()
    {
        ...
        $this->assertEquals(array(array('setBar', array()), array('setBar', array(new Expression('service("foo") ~ parameter("foo")')))), $services['method_call1']->getMethodCalls(), '->load() parses the method_call tag');
