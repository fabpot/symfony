...
class TemplatingExtension extends \Twig_Extension
{
    ...
    public function getTokenParsers()
    {
        return array(
            ...
            // {% route 'blog_post' with ['id': post.id] absolute true %}
            new HelperTokenParser('route', '<route> [with <arguments:array>] [absolute <absolute>]', 'templating.helper.router', 'generate'),
