...
namespace Symfony\Bundle\DoctrineBundle\Test;
    ...
    public function getContainer()
    {
        $container = new ContainerBuilder(new ParameterBag(array(
            'kernel.bundle_dirs' => array(
                'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles' =>
                __DIR__ . "/DependencyInjection/Fixtures/Bundles"
            ),
            'kernel.bundles'     => array(
                'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\YamlBundle\YamlBundle',
            ),
        ...
        $code = $dumper->dump(array('class' => 'DoctrineBundleTestProjectServiceContainer'));
        eval(str_replace('<?php', null, $code));
        return new \DoctrineBundleTestProjectServiceContainer;
    }
