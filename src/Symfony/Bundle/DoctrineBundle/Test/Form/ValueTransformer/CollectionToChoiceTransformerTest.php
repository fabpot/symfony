...
class CollectionToChoiceTransformerTest extends \Symfony\Bundle\DoctrineBundle\Test\TestCase
{
    /**
     * @var EntityManager
     */
    ...
    public function createTransformer()
    {
        return new CollectionToChoiceTransformer(array(
            "em" => $this->em,
            "className" => 'Symfony\Bundle\DoctrineBundle\Test\Form\ValueTransformer\Tag'
        ));
    }
    ...
    public function testReverseTransformRemoveMissingFromCollection()
    {
        ...
        $this->assertFalse($newCol->contains($this->em->find('Symfony\Bundle\DoctrineBundle\Test\Form\ValueTransformer\Tag', 2)));
    }
}