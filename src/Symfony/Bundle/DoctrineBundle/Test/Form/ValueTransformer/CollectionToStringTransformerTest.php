...
namespace Symfony\Bundle\DoctrineBundle\Test\Form\ValueTransformer;

use Symfony\Bundle\DoctrineBundle\Form\ValueTransformer\CollectionToStringTransformer;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\ORM\Tools\SchemaTool;

class CollectionToStringTransformerTest extends \Symfony\Bundle\DoctrineBundle\Test\TestCase
{
    /**
     * @var EntityManager
     */
    ...
    protected function setUp()
    {
        ...
        $classes = array($this->em->getClassMetadata('Symfony\Bundle\DoctrineBundle\Test\Form\ValueTransformer\Tag'));
        try {
    ...
    public function testNoEntityManagerThrowsException()
    {
        ...
        $transformer = new CollectionToStringTransformer(array(
            'class_name' => 'Symfony\Bundle\DoctrineBundle\Test\Form\ValueTransformer\Tag',
            'field_name' => 'name',
        ));
    }
    ...
    public function testReverseTransformNewUnknownEntity()
    {
        ...
        $this->assertEquals(1, count($this->em->getRepository('Symfony\Bundle\DoctrineBundle\Test\Form\ValueTransformer\Tag')->findAll()));
    }
