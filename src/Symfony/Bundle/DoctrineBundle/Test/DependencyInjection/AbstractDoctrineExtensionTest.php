...
namespace Symfony\Bundle\DoctrineBundle\Test\DependencyInjection;

use Symfony\Bundle\DoctrineBundle\Test\TestCase;
...
abstract class AbstractDoctrineExtensionTest extends TestCase
{
    ...
    public function testDependencyInjectionConfigurationDefaults()
    {
        ...
        $this->assertEquals(array('YamlBundle' => 'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\YamlBundle\Entity'), $calls[0][1][0]);
    ...
    public function testBundleEntityAliases()
    {
        ...
        $this->assertDICDefinitionMethodCallOnce($definition, 'setEntityNamespaces',
            array(array('YamlBundle' => 'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\YamlBundle\Entity'))
        );
    }
    ...
    public function testOverwriteEntityAliases()
    {
        ...
        $definition = $container->getDefinition('doctrine.orm.default_configuration');
        $this->assertDICDefinitionMethodCallOnce($definition, 'setEntityNamespaces',
            array(array('yml' => 'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\YamlBundle\Entity'))
        );
    }
    ...
    public function testYamlBundleMappingDetection()
    {
        ...
        $this->assertDICDefinitionMethodCallOnce($definition, 'addDriver', array(
            ...
            'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\YamlBundle\Entity'
        ));
    }
    ...
    public function testXmlBundleMappingDetection()
    {
        ...
        $this->assertDICDefinitionMethodCallOnce($definition, 'addDriver', array(
            ...
            'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\XmlBundle\Entity'
        ));
    }
    ...
    public function testAnnotationsBundleMappingDetection()
    {
        ...
        $this->assertDICDefinitionMethodCallOnce($definition, 'addDriver', array(
            ...
            'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\AnnotationsBundle\Entity'
        ));
    }
    ...
    public function testSingleEntityManagerMultipleMappingBundleDefinitions()
    {
        ...
        $this->assertDICDefinitionMethodCallAt(2, $definition, 'addDriver', array(
            new Reference('doctrine.orm.default_xml_metadata_driver'),
            'Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\XmlBundle'
        ));
    ...
    public function testAnnotationsBundleMappingDetectionWithVendorNamespace()
    {
        ...
        $this->assertEquals('Symfony\Bundle\DoctrineBundle\Test\DependencyInjection\Fixtures\Bundles\Vendor\AnnotationsBundle\Entity', $calls[0][1][1]);
    }
    ...
    protected function getContainer($bundles = 'YamlBundle', $vendor = null)
    {
        ...
        foreach ($bundles AS $key => $bundle) {
            ...
            $bundles[$key] = 'Symfony\Bundle\DoctrineBundle\\Test\DependencyInjection\\Fixtures\\Bundles\\'.($vendor ? $vendor.'\\' : '').$bundle.'\\'.$bundle;
        }

        return new ContainerBuilder(new ParameterBag(array(
            'kernel.bundle_dirs' => array('Symfony\Bundle\DoctrineBundle\\Test\\DependencyInjection\\Fixtures\\Bundles' => __DIR__.'/Fixtures/Bundles'),
