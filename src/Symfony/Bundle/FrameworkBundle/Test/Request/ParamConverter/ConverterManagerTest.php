...
namespace Symfony\Bundle\FrameworkBundle\Test\Request\ParamConverter;
...
class ConverterManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return new \ReflectionParameter(array('Symfony\Bundle\FrameworkBundle\Test\Request\ParamConverter\Fixtures\ConvertableObject', 'typehintedMethod'), 'object');
    }
