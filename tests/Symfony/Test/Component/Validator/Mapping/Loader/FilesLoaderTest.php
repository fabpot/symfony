...
class FilesLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCallsActualFileLoaderForMetadata()
    {
        ...
        $loader->loadClassMetadata(new ClassMetadata('Symfony\Test\Component\Validator\Fixtures\Entity'));
    }

    public function getFilesLoader(LoaderInterface $loader)
    {
        return $this->getMockForAbstractClass('Symfony\Test\Component\Validator\Fixtures\FilesLoader', array(array(
