...
namespace Symfony\Test\Component\HttpKernel;
...
class ControllerResolverTest extends \PHPUnit_Framework_TestCase
{
    public function testGetController()
    {
        ...
        $request->attributes->set('_controller', 'Symfony\Test\Component\HttpKernel\ControllerResolverTest::testGetController');
        $controller = $resolver->getController($request);
        $this->assertInstanceOf('Symfony\Test\Component\HttpKernel\ControllerResolverTest', $controller[0], '->getController() returns a PHP callable');
        $this->assertEquals(array('Using controller "Symfony\Test\Component\HttpKernel\ControllerResolverTest::testGetController"'), $logger->getLogs('info'));
        ...
        $request->attributes->set('_controller', 'Symfony\Test\Component\HttpKernel\ControllerResolverTest::bar');
        try {
            $resolver->getController($request);
