...
////// FIXME
    ...
    {
        $definition = new Definition('Symfony\Test\Component\DependencyInjection\FooClass');

        $injector = $this->getMockInterfaceInjector('Symfony\Test\Component\DependencyInjection\FooClass', 1);
        $injector2 = $this->getMockInterfaceInjector('Symfony\Test\Component\DependencyInjection\FooClass', 0);

        $container = new ContainerBuilder();
        $container->addInterfaceInjector($injector);
        $container->addInterfaceInjector($injector2);
        $this->assertEquals(1, count($container->getInterfaceInjectors('Symfony\Test\Component\DependencyInjection\FooClass')));
    ...
    {
        $injector = $this->getMock('Symfony\Component\DependencyInjection\InterfaceInjector', array('processDefinition'), array('Symfony\Test\Component\DependencyInjection\FooClass'), '', true, false);
