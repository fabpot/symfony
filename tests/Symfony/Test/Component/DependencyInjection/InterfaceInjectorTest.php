...
namespace Symfony\Test\Component\DependencyInjection;
...
class InterfaceInjectorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $injector = new InterfaceInjector('Symfony\Test\Component\DependencyInjection\Service');
        $injector->addMethodCall('method');

        $definition = $this->getMockDefinition('Symfony\Test\Component\DependencyInjection\Service', 1);
    ...
    {
        $injector1 = new InterfaceInjector('Symfony\Test\Component\DependencyInjection\Service');
        $injector1->addMethodCall('method_one');

        $injector2 = new InterfaceInjector('Symfony\Test\Component\DependencyInjection\Service');
    ...
    public function getInjectorsAndDefintions()
    {
        ...
        $definition2 = $this->getMockDefinition('Symfony\Test\Component\DependencyInjection\Service', 4);
    ...
    {
        return array(
            array(new InterfaceInjector('Symfony\Test\Component\DependencyInjection\Service'), 'Symfony\Test\Component\DependencyInjection\Service', true),
            array(new InterfaceInjector('Symfony\Test\Component\DependencyInjection\SubService'), 'Symfony\Test\Component\DependencyInjection\Service', false),
            array(new InterfaceInjector('Symfony\Test\Component\DependencyInjection\Service'), 'Symfony\Test\Component\DependencyInjection\SubService', true),
            array(new InterfaceInjector('Symfony\Test\Component\DependencyInjection\SubService'), 'Symfony\Test\Component\DependencyInjection\SubService', true),
            array(new InterfaceInjector('Symfony\Test\Component\DependencyInjection\FooInterface'), 'Symfony\Test\Component\DependencyInjection\SubService', true),
            array(new InterfaceInjector('Symfony\Test\Component\DependencyInjection\FooInterface'), 'Symfony\Test\Component\DependencyInjection\Service', false),
            array(new InterfaceInjector('Symfony\Test\Component\DependencyInjection\FooInterface'), 'Symfony\Test\Component\DependencyInjection\ServiceWithConstructor', false),
        );
    }
