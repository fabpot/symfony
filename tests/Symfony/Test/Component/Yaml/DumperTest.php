...
namespace Symfony\Test\Component\Yaml;
...
EOF;
    ...
    public function testObjectsSupport()
    {
        ...
        $this->assertEquals('{ foo: !!php/object:O:29:"Symfony\Test\Component\Yaml\A":1:{s:1:"a";s:3:"foo";}, bar: 1 }', $this->dumper->dump($a), '->dump() is able to dump objects');
    }
}
