...
class InterfaceInjectorTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Symfony\Component\DependencyInjection\InterfaceInjector::isFor
     *
     ...
     */
    public function testIsFor(InterfaceInjector $injector, $class, $expectedResult)
    {
        $this->assertEquals($expectedResult, $injector->isFor($class), '->isFor() must return true if injector is to be used on a class, false otherwise');
    }
