...
{
    public function testConstructorDoesNotNeedLoggerImplementation()
    {
        ...
        $this->assertSame($context, $listener->getSecurityContext());
        $this->assertSame($service, $listener->getRememberMeServices());
        $this->assertSame($manager, $listener->getAuthenticationManager());
        $this->assertNull($listener->getLogger());
    }
    ...
    public function testConstructor()
    {
        ...
        $this->assertSame($service, $listener->getRememberMeServices());
        $this->assertSame($manager, $listener->getAuthenticationManager());
        $this->assertSame($logger, $listener->getLogger());
    }
    ...
    {
        return $this->getMock('Symfony\Component\Security\SecurityContext');
    }
}