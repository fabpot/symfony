...
class FlattenExceptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFlattenHttpException(\Exception $exception, $statusCode)
    {
        ...
        $this->assertEquals($statusCode, $flattened->getStatusCode(), 'A HttpKernelInterface exception uses the error code as the status code.');
...
// stub Exception class that implements HttpExceptionInterface
